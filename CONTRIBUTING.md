...
* Check the [Issues](https://github.com/shackApp/mean-core/issues) on Github to ensure one doesn't already exist.
...
The code for the documentation and the website are located in the shackApp/mean-core repo on the gh-pages branch. The website is hosted by github pages and generated using jekyll. See the README in the gh-pages branch for more information on how to get your dev environment set-up.
